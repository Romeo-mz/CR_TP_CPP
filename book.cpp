...
//Constructeur
Book::Book(std::string title, Author a, std::string language, std::string type, Date d, std::string ISBN) : 
_title(title), _a(a), _language(language), _type(type), _d(d), _ISBN(ISBN) {
}
